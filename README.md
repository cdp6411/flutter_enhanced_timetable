# flutter_enhanced_timetable

📅 Customizable, animated calendar widget including day, week, and month views.

## Notice

This package, `flutter_enhanced_timetable`, is a fork of the original `timetable` package. We have created this fork to maintain and enhance the package for use in a production app. For more details about the original package, please refer to its repository: [timetable](https://pub.dev/packages/timetable).
...
| :-------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------: |
| ![](https://github.com/CaughtUp-LLC/Flutter-Enhanced-Timetable/raw/main/doc/demo-navigation.webp?raw=true) | ![](https://github.com/CaughtUp-LLC/Flutter-Enhanced-Timetable/raw/main/doc/demo-animation.webp?raw=true) |

|                                       Callbacks                                        |                               Changing the [`VisibleDateRange`]                               |
| :------------------------------------------------------------------------------------: | :-------------------------------------------------------------------------------------------: |
| ![](https://github.com/CaughtUp-LLC/Flutter-Enhanced-Timetable/raw/main/doc/demo-callbacks.webp?raw=true) | ![](https://github.com/CaughtUp-LLC/Flutter-Enhanced-Timetable/raw/main/doc/demo-visibleDateRange.webp?raw=true) |
...
| :---------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------: |
| ![](https://github.com/CaughtUp-LLC/Flutter-Enhanced-Timetable/raw/main/doc/screenshot-MultiDateTimetable-light.webp?raw=true) | ![](https://github.com/CaughtUp-LLC/Flutter-Enhanced-Timetable/raw/main/doc/screenshot-MultiDateTimetable-dark.webp?raw=true) |
...
|                                                      Light Mode                                                      |                                                      Dark Mode                                                      |
| :------------------------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------------------: |
| ![](https://github.com/CaughtUp-LLC/Flutter-Enhanced-Timetable/raw/main/doc/screenshot-RecurringMultiDateTimetable-light.webp?raw=true) | ![](https://github.com/CaughtUp-LLC/Flutter-Enhanced-Timetable/raw/main/doc/screenshot-RecurringMultiDateTimetable-dark.webp?raw=true) |
...
|                                                   Light Mode                                                   |                                                   Dark Mode                                                   |
| :------------------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------------: |
| ![](https://github.com/CaughtUp-LLC/Flutter-Enhanced-Timetable/raw/main/doc/screenshot-CompactMonthTimetable-light.webp?raw=true) | ![](https://github.com/CaughtUp-LLC/Flutter-Enhanced-Timetable/raw/main/doc/screenshot-CompactMonthTimetable-dark.webp?raw=true) |
...
<img src="https://github.com/CaughtUp-LLC/Flutter-Enhanced-Timetable/raw/main/doc/demo-dragAndDrop.webp?raw=true" width="400px" alt="Drag and Drop demo" />
...
<img src="https://github.com/CaughtUp-LLC/Flutter-Enhanced-Timetable/raw/main/doc/screenshot-timeOverlays.webp?raw=true" width="400px" alt="Drag and Drop demo" />
...
[example/main.dart]: https://github.com/CaughtUp-LLC/Flutter-Enhanced-Timetable/blob/main/example/lib/main.dart
<!-- Flutter -->
